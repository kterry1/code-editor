...
const OpenWorkspace = () => {
    ...
    return (
        <div>
           <Button className={classes.button} onClick={onClick}>Open Workspace</Button>
           <input type="file" className={classes.input} webkitdirectory="" directory="" ref={directoryInputRef} onChange={onFilesUploaded}/>
        </div>
    )
}
